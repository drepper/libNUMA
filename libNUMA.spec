...
%defattr(-,root,root,-)
%doc
%{_libdir}/libNUMA-%{version}.so
%{_libdir}/libNUMA.so.%{ABI}
...
%changelog
* Thu Jun 21 2012 Ulrich Drepper <drepper@gmail.com> - 1.2
- Add NUMA_ifname_to_cpu_mask interface

* Mon Apr  9 2012 Ulrich Drepper <drepper@gmail.com> - 1.0
- Initial build.
